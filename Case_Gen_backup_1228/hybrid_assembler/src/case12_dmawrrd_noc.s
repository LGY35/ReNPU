...
NOC_cfg (addr=114 , wdata=5, cfifo_wdata=0,cfifo_en=0)    # ping lenth
...
NOC_cfg (addr=70 , wdata=512 , cfifo_wdata=0,cfifo_en=0)
...
NOC_cfg (addr=79 , wdata=17, cfifo_wdata=0,cfifo_en=0)
NOC_cfg (addr=80 , wdata=0, cfifo_wdata=0,cfifo_en=0)
NOC_cfg (addr=81 , wdata=17, cfifo_wdata=0,cfifo_en=0)
...
noc_req (comd_type=2, bar=0, cfifo_wdata=0,cfifo_en=0)    # 先设置成相同的barrier,这样上面的不执行完下面的不会执行
noc_req (comd_type=4, bar=0, cfifo_wdata=0,cfifo_en=0)    # 先设置成相同的barrier,这样上面的不执行完下面的不会执行
