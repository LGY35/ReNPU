...
# process_file('./case3.txt', './hex_file_little_endian.txt')
...
# output_file_path = '../../DVcase/case3_corerd/case3_instr_core.txt'  # 替换为您的输出文件路径
...
def main():
    ...
    # 第一步
    process_file(args.input, './hex_file_little_endian.txt')
    process_file2('./hex_file_little_endian.txt', args.output)
