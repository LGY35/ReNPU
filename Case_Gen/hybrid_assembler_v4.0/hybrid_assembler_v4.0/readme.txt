hybrid_assembler_v4.0

使用说明：
1. hybrid_assembler_v4.0: cpu和npu混合汇编器，可通过-h查看usage。
2. inst_set_v4.0.s: 默认的输入文件，存放汇编指令。
...
conv3d_start (first_sub_flag=0, start_index=0, end_index=29, tcache_stride=0, tcache_offset=0, bc_mode=0, bc_len=16, rgba_mode=0, rgba_stride=0, rgba_shift=0, hl_op=0, bc_keep_2cycle_en=0, pad0_sel=end, pad0_len=0, run_cycle_num=32, cfifo_en=1, bar=1)
