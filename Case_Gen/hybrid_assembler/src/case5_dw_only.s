...
NOC_cfg (addr=112 , wdata=2048)   # loop lenth
NOC_cfg (addr=114 , wdata=2048)    # ping lenth  
...
NOC_cfg (addr=4 , wdata=0 )    # 开pingpang
NOC_cfg (addr=5 , wdata=0 )
NOC_cfg (addr=6 , wdata=0 )  # ping基地址
NOC_cfg (addr=7 , wdata=0 ) # pang基地址
...
NOC_cfg (addr=15 , wdata=576)  # lenth3
NOC_cfg (addr=16 , wdata=0)   # pingpangnum = 0
NOC_cfg (addr=17 , wdata=576)
