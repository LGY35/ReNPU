...
NOC_cfg (addr=98  , wdata=1, cfifo_wdata=0,cfifo_en=0 ) #广播
...
NOC_cfg (addr=112 , wdata=17, cfifo_wdata=0,cfifo_en=0)   # loop lenth
NOC_cfg (addr=113 , wdata=0, cfifo_wdata=0,cfifo_en=0)
NOC_cfg (addr=114 , wdata=17, cfifo_wdata=0,cfifo_en=0)   # ping lenth
NOC_cfg (addr=115 , wdata=0, cfifo_wdata=0,cfifo_en=0 )
NOC_cfg (addr=116 , wdata=80, cfifo_wdata=0,cfifo_en=0 )   # 0000 0101 0000  中心节点0000 
NOC_cfg (addr=117 , wdata=33, cfifo_wdata=0,cfifo_en=0 )   # sync target  0000 0010 0001 
