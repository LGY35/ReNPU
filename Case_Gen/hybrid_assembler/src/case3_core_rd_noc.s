...
NOC_cfg (cfifo_en=0, addr=3 , wdata=0 )    # 0片外读取
NOC_cfg (cfifo_en=0, addr=4 , wdata=0 )
NOC_cfg (cfifo_en=0, addr=5 , wdata=0 )
NOC_cfg (cfifo_en=0, addr=6 , wdata=512 )    # ping基地址 4096/8
...
# 第二次,取64个
NOC_cfg (cfifo_en=0, addr=6 , wdata=1088 )    # ping基地址 512+576
NOC_cfg (cfifo_en=0, addr=15 , wdata=63)   # lenth3
NOC_cfg (cfifo_en=0, addr=17 , wdata=63)

# 第三次 取2048个
NOC_cfg (cfifo_en=0, addr=6 , wdata=1152 )    # ping基地址 1088+64
