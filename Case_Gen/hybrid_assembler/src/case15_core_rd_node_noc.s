...
# 绝对寻址
# core rd 第一次取576个
NOC_cfg (acfifo_en=0, ddr=0 , wdata=0 )     # 0 绝对寻址
NOC_cfg (acfifo_en=0, ddr=1 , wdata=0 )
NOC_cfg (acfifo_en=0, ddr=2 , wdata=0 )
NOC_cfg (acfifo_en=0, ddr=3 , wdata=1 )     # 1片上读取
NOC_cfg (acfifo_en=0, ddr=4 , wdata=0 )
NOC_cfg (acfifo_en=0, ddr=5 , wdata=1 )     # 目的节点坐标，相当于地址的最高4位---节点1，所以是1
NOC_cfg (acfifo_en=0, ddr=6 , wdata=0 )     # ping基地址 0
NOC_cfg (acfifo_en=0, ddr=7 , wdata=0 )
NOC_cfg (acfifo_en=0, ddr=8 , wdata=0 )     # gap0
NOC_cfg (acfifo_en=0, ddr=9 , wdata=0 )     # gap1
NOC_cfg (acfifo_en=0, ddr=10 , wdata=0 )    # gap2 
NOC_cfg (acfifo_en=0, ddr=11 , wdata=1 )    # gap3
NOC_cfg (acfifo_en=0, ddr=12 , wdata=0 )    # lenth0
NOC_cfg (acfifo_en=0, ddr=13 , wdata=0 )    # lenth1
NOC_cfg (acfifo_en=0, ddr=14 , wdata=0)     # lenth2
NOC_cfg (acfifo_en=0, ddr=15 , wdata=575)   # lenth3
NOC_cfg (acfifo_en=0, ddr=16 , wdata=0)   
NOC_cfg (acfifo_en=0, ddr=17 , wdata=575)
NOC_cfg (acfifo_en=0, ddr=18 , wdata=0)
NOC_cfg (acfifo_en=0, ddr=19 , wdata=0)
NOC_cfg (acfifo_en=0, ddr=20 , wdata=0)
NOC_cfg (acfifo_en=0, ddr=21 , wdata=0)   
...
# core rd 第二次取64个
NOC_cfg (cfifo_en=0, addr=0 , wdata=1 )     # 1 相对寻址
NOC_cfg (cfifo_en=0, addr=1 , wdata=20 )     # bit4 = 1，比当前节点小  bit 3:0=  5-1=4= 0100   10100
NOC_cfg (cfifo_en=0, addr=2 , wdata=0 )
NOC_cfg (cfifo_en=0, addr=3 , wdata=1 )     # 1片上读取
NOC_cfg (cfifo_en=0, addr=4 , wdata=0 )
NOC_cfg (cfifo_en=0, addr=5 , wdata=1 )     # 目的节点坐标，相当于地址的最高4位---节点1，所以是1
